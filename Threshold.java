class Threshold
{
	...
	private int scale   = 0; //JFLOAT
	private int span    = 0; //JFLOAT
	...
	{
		/*JFLOAT
		if(span < 1) return tagimage.getPixel((int)((float)x*scale), (int)((float)y*scale) );	
	...
	*/
	...
	{
		//JFLOAT dbgpixmap.setPixel((int)((float)x*scale), (int)((float)y*scale), 0, max_rgb, 0);	
		//dbgpixmap.setPixel((x*scale)/100, (y*scale)/100, 0, max_rgb, 0);	
	...
	{
		//JFLOAT dbgpixmap.setPixel((int)((float)x*scale), (int)((float)y*scale), max_rgb, max_rgb, max_rgb);	
		//dbgpixmap.setPixel((x*scale)/100, (y*scale)/100, max_rgb, 0, 0);	
	...
	{
		//JFLOAT dbgpixmap.setPixel((int)((float)x*scale), (int)((float)y*scale), 0, 0, 0);	
		//dbgpixmap.setPixel((x*scale)/100, (y*scale)/100, 0, 0, max_rgb);	
